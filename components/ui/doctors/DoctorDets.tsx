          ...
          <div className="mt-3 md:mt-0 md:w-full">
            ...
            <div className="flex gap-3 md:gap-4 items-center mt-4 md:mt-5 max-w-96 mx-auto">
              ...
              <div className="flex flex-col gap-2 w-2/3">
                ...
                <Button className="center" onClick={() => setOpenContact(true)}>
                  Call for booking
                </Button>
              </div>
            </div>
          ...
          <React.Fragment>
            ...
            <div>
              <SuggestedDoctors hospitalID={hospital.id} nID={doctor.id}>
                <h3 className="text-lg lg:text-2xl leading-tight font-bold opacity-90 ml-2 mt-6 mb-1">
            ...
            {/* top rated doctors */}
            <div className="mt-6">
              <h3 className="text-lg lg:text-2xl leading-tight font-bold opacity-90 ml-2 mb-1">
        ...
        <Button
          ...
          onClick={() => {
            if (typeof window !== "undefined") {
              window.open(`tel:${+8801867578749}`)
            }
          }}
        >
          <Icon name="phone" className="size-5" />
          <span>+8801867578749</span>
        </Button>
      </Modal>
    </React.Fragment>
  )
